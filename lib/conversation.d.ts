...
import { AssistantLanguage, AssistantRequest, AssistantResponse, AssistantSpeechRecognitionResult } from './common';
...
export declare class Conversation extends EventEmitter {
     ...
     * @constructor
     */
    constructor(_stream: ClientDuplexStream<AssistRequest, AssistResponse>, _deviceId: string, _deviceModelId: string, locale: AssistantLanguage);
    sendRawRequest(rawRequest: AssistRequest): boolean;
    sendRequest(request: AssistantRequest): boolean;
    end(): Promise<void>;
    private _setupEvents;
}
/***** TYPINGS ************************************************************************************/
export declare type ConversationEvent = 'data' | 'action' | 'actionongoogle' | 'audio' | 'conversationend' | 'message' | 'html' | 'volume' | 'speechrecognition' | 'utteranceend';
export declare interface Conversation {
     ...
     * @returns The conversation.
     */
    addListener(event: 'speechrecognition', listener: (speechRecognitionResults: AssistantSpeechRecognitionResult[]) => void): this;
    /**
     ...
     * @returns The conversation.
     */
    on(event: 'speechrecognition', listener: (speechRecognitionResults: AssistantSpeechRecognitionResult[]) => void): this;
    /**
     * Adds an event listener that will be triggered when the Assistant detects the end of the user's
     * speech utterance and expects no additional speech. Therefore, it will not process additional audio
     * (although it may subsequently return additional results).
     ...
     * @returns The conversation.
     */
    once(event: 'speechrecognition', listener: (speechRecognitionResults: AssistantSpeechRecognitionResult[]) => void): this;
    /**
